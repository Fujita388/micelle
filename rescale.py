#decomp.atomsとdecomp.lammpstrjを読み込んで座標を1.05倍にする
class Atoms:
...
def readdump(atoms, bonds, atoms_file, dump_file, scale):
    ...
    step = []  #ダンプファイルにおけるstep始まりのインデックスの配列
    ...
    mol_list = [0 for i in range(num_atoms)]
...
L = readdump(atoms, bonds, "decomp.atoms", "decomp.lammpstrj", 1.05)
